...
RUN     addgroup -S nginx \
        ...
        && apk add --no-cache --virtual .build-deps \
                ...
                geoip-dev \
                libmaxminddb-dev \
        && curl -fSL "https://github.com/alibaba/tengine/archive/$TENGINE_VERSION.tar.gz" -o tengine.tar.gz \
        ...
        && rm -fr tengine.tar.gz ngx_http_geoip2_module.tar.gz \
        && cd /usr/src/tengine-$TENGINE_VERSION \
        && curl -fSL "https://github.com/openresty/headers-more-nginx-module/archive/v0.33.tar.gz" -o more.tar.gz \
